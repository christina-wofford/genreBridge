...
from googleapiclient.discovery import build #Google Books API
import nltk #NLTK for keyword extraction
from nltk.corpus import stopwords
from flask import Flask, request, jsonify #Flask for backend/frontend communication
from flask_cors import CORS 
import json #JSON for data transfer
import ssl
import spotipy #
...
#nltk.download('stopwords') #Download stopwords for keyword extraction
...
#Flask App to receive data from frontend
app = Flask(__name__)
...
def search():
    ...
    #Store relevent playlist data from Spotify API response
    if playlist_id:
    ...
    #Close connection
    connection.close()
def store_track_info(track, playlist_id):
    # Get artist data
...
#Stop Flask from capturing stdout
